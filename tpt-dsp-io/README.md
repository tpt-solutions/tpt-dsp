...
an async TCP IQ server, and (behind features) built-in audio I/Oput and serial
readers.
...
| `audio`    | `audio`      | Built-in dependency-free real-time audio: `run_output`, `run_input`, `list_output_devices`, `list_input_devices`.                         |
